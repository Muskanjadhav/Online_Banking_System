...
public class Details extends javax.swing.JFrame {
    ...
    public Details(String id) {
        ...
        s2="select * from tb_signup where fdPinCode='"+this.id+"'";
        try
        {
          db.rs=db.stm.executeQuery(s2);
          db.rs.next();
          name = db.rs.getString(1);
          Phone_Number = db.rs.getString(2);
          Pin = db.rs.getString(4);
          AccountId= db.rs.getString(10);
          Address= db.rs.getString(6);
          Gender= db.rs.getString(7);
          Nationality= db.rs.getString(8);
          dob= db.rs.getString(9);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        s10="Update  tb_signup set fd_PhoneNumber='"+s1+"',fdPinCode='"+s2+"',fdName='"+s3+"',fd_Address='"+s4+"' WHERE fdPinCode='"+id+"'";
