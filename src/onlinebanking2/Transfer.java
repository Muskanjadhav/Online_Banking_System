...
public class Transfer extends javax.swing.JFrame {
    ...
    public Transfer(String id) {
        ...
        s2="select * from tb_signup where fdPinCode='"+SenderId+"'";
        try
        {
          db.rs=db.stm.executeQuery(s2);
          while(db.rs.next())
...
if (amount.equals("")) {
    ...
    String s11 = "Select * from tb_signup where fdPinCode='" + SenderId + "'";
    ...
    if (s14 <= amount11) 
    {
        ...
        try {
            db.rs = db.stm.executeQuery(s2);
            db.rs.next();
            int Reciver_amount = db.rs.getInt(11);
        ...
        try {
            ...
            String s12 = "Update tb_signup set fd_Amount='" + Total_Amount + "' where fdPinCode='" + SenderId + "'";
