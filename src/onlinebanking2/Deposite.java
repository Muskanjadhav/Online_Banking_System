...
public class Deposite extends javax.swing.JFrame {
    ...
    public Deposite(String id){
        ...
        s2="select * from tb_signup where fdPinCode='"+id1+"'";
        try
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        s3="select * from tb_signup where fdPinCode='"+id1+"'";
        try
        {
        ...
        else
        {
            ...
            String s10 = "Update  tb_signup set fd_Amount='" + total_Amount + "' where fdPinCode='" + id1 + "'";
